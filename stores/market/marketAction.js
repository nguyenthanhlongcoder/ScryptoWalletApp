...
export function getHoldings(holdings= [], currency = "vnd", orderBy = "market_cap_desc", sparkline = true, priceChangePerc = "7d", perPage = 10, page = 1){
    return dispatch => {
        ...
        return axios({
            ...
            if (respone.status == 200){
                ...
                dispatch(getHoldingsFailure(respone.data))
            }
        }).catch((error)=>{
...
export function getCoinMarket(currency = "vnd", orderBy = "market_cap_desc", sparkline = true, priceChangePerc = "7d", perPage = 10, page = 1){
    return dispatch => {
        ...
        return axios({
            ...
            if (respone.status == 200){
                dispatch(getCoinMarketSuccess(respone.data))
            }else{
                dispatch(getCoinMarketFailure(respone.data))
